...
function xhprof_generate_mime_header($type, $length) {
  ...
  if ($mime) {
  	//xhprof_http_header('Pragma', 'public');
    //xhprof_http_header('Cache-Control', 'must-revalidate, post-check=0, pre-check=0');
    //xhprof_http_header('Cache-Control', 'private');
    xhprof_http_header('Content-type', $mime);
    //xhprof_http_header('Content-Disposition', 'inline');
